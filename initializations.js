...
const Initializations = {
  ...
  parallelLinesOneAcross: (num_boids) => ({
    ...
    initialize: (boid_radius, evasion_strength) => {
      let boids = [];
      boids[0] = new Boid(createVector(-width * 0.45, 0), createVector(width * 0.45, 0), color(0, 255, 255), radius = boid_radius, evasion_strength = evasion_strength);
      boids[1] = new Boid(createVector(width * 0.45, 0), createVector(-width * 0.45, 0), color(0, 255, 255), radius = boid_radius, evasion_strength = evasion_strength);
